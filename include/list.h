...
/**
 * @brief returns and removes the object put into the list the LEAST recently
 *
 * @param list the queue to take the first element of
 * @return void * the next object stored in the queue
 */
void *dequeue(list_t *list);

/**
 * @brief Adds the given object to the array at the given index
 *
