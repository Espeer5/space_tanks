...
/**
 * @brief Creates a body where the associated shape is a star
 *
 * @param center
 * @param mass
 * @param color
 * @return body_t*
 */
body_t *star_body(vector_t center, double mass, rgb_color_t color);

/**
 * @brief Creates a simple shape to use in testing body methods
 *
 * @return list_t*
 */
list_t *make_shape();
