...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/pacman.data';
...
Module['FS_createPath']("/levels", "level1", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/pacman.data');

      };
      Module['addRunDependency']('datafile_bin/pacman.data');
    ...
    loadPackage({"files": [{"filename": "/levels/level1/enemy.dat", "start": 0, "end": 19}, {"filename": "/levels/level1/walls.dat", "start": 19, "end": 39}], "remote_package_size": 39, "package_uuid": "380f982f-3abc-4817-97f9-533113e1db5b"});
